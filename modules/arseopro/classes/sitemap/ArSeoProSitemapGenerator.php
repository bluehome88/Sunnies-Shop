...
class ArSeoProSitemapGenerator
{
    ...
    {
        $this->data = $data;
        file_put_contents($this->module->getSitemapBasePath(true) . $this->path . 'data.json', json_encode($data));
    }
    ...
    public function updateRobots()
    {
        ...
        $robots = preg_replace('{^\n$}im', '', $robots);
        $lines = array();
        $lines[] = "#~~arseopro sitemaps (this section genetates automatically by sitemap submodule)~~#";
        foreach ($sitemaps as $sitemap) {
