...
class ArSeoProURLManufacturer extends ArSeoProURLAbstract
{
    ...
    public function dispatch()
    {
        ...
        if (Tools::getValue('ars_rewrite_manufacturer')) {
            ...
            if (!$id_manufacturer) {
                if ($this->redirect == ArSeoProURLManufacturer::REDIRECT_LIST) {
                    $this->owner->redirect($context->link->getPageLink('manufacturer'), ArSeoHelpers::getResponseHeader(301));
                }
