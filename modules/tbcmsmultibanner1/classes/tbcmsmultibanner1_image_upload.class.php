...
include('tbcmsmultibanner1_image_resize.class.php');
class TbcmsMultiBanner1ImageUpload extends Module
{
    ...
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tbcmsmultibanner1/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsMultiBanner1ImageResize($save_destination);
                // Resize image
