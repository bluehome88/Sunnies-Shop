...
class TbcmsStockInfo extends Module
{
    // show design Types
    ...
    protected $configs = array(
        'TB_DISPLAY_WHEN_BELOW_LIMIT' => 0,
        'TB_DISPLAY_IN_CATS' => '',
        'TB_DISPLAY_IN_PRODUCT_LISTS' => true,
        'TB_DISPLAY_ON_PRODUCT_PAGE' => true,
        'TB_DISPLAY_NR_OF_ITEMS' => true,
        'TB_INDICATOR_FULL_AT' => 300,
        'TB_INDICATOR_DESIGN' => 'bar',
        'TB_ENABLE_PROGRESSIVE_COLORS' => true,
    );
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('TemplateBeta - Stock Indicator');
    ...
    public function createVariable()
    {
        ...
        Configuration::updateValue('TB_DISPLAY_WHEN_BELOW_LIMIT', 0);
        Configuration::updateValue('TB_DISPLAY_IN_CATS', $category_list);
        Configuration::updateValue('TB_DISPLAY_IN_PRODUCT_LISTS', true);
        Configuration::updateValue('TB_DISPLAY_ON_PRODUCT_PAGE', true);
        Configuration::updateValue('TB_DISPLAY_NR_OF_ITEMS', 'true');
        Configuration::updateValue('TB_INDICATOR_FULL_AT', 300);
        Configuration::updateValue('TB_INDICATOR_DESIGN', 'bar');
        Configuration::updateValue('TB_ENABLE_PROGRESSIVE_COLORS', true);
    }
    ...
    {
        Configuration::deleteByName('TB_DISPLAY_WHEN_BELOW_LIMIT');
        Configuration::deleteByName('TB_DISPLAY_IN_CATS');
        Configuration::deleteByName('TB_DISPLAY_IN_PRODUCT_LISTS');
        Configuration::deleteByName('TB_DISPLAY_ON_PRODUCT_PAGE');
        Configuration::deleteByName('TB_DISPLAY_NR_OF_ITEMS');
        Configuration::deleteByName('TB_INDICATOR_FULL_AT');
        Configuration::deleteByName('TB_INDICATOR_DESIGN');
        Configuration::deleteByName('TB_ENABLE_PROGRESSIVE_COLORS');
    }
    ...
    protected function getSettingsForm()
    {
        ...
        $TB_DISPLAY_NR_OF_ITEMS_DESC = $this->l('If the number of items is not displayed, you must select '
            .'a visible stock indicator design.');
        $TB_INDICATOR_FULL_AT_DESC = $this->l('The indicator will be displayed as full when the product '
        ...
        foreach ($all_category as $category) {
            ...
            $tmp = Configuration::get('TB_DISPLAY_IN_CATS');
            // $tmp = str_replace("[", "", $tmp);
            // $tmp = str_replace("]", "", $tmp);
        ...
        return array(
            ...
            'input' => array(
                array(
                    ...
                    'name' => 'TB_DISPLAY_ON_PRODUCT_PAGE',
                ...
                array(
                    ...
                    'name' => 'TB_DISPLAY_IN_PRODUCT_LISTS',
                    'values' => $this->getYesOrNoValues(),
                    'col' => 3,
                ),
                array(
                ...
                array(
                    ...
                    'desc' => $TB_DISPLAY_NR_OF_ITEMS_DESC,
                    'name' => 'TB_DISPLAY_NR_OF_ITEMS',
                    'values' => $this->getYesOrNoValues(),
                    'col' => 3,
                ),
                array(
    ...
    protected function processSettingsForm()
    {
        ...
        foreach (array_keys($this->configs) as $config) {
            ...
            } elseif ($config == 'TB_DISPLAY_WHEN_BELOW_LIMIT' || $config == 'TB_INDICATOR_FULL_AT') {
    ...
    protected function validateSettingsForm()
    {
        ...
        foreach (array_keys($this->configs) as $config) {
            ...
            if ($config == 'TB_DISPLAY_WHEN_BELOW_LIMIT' && ! Validate::isUnsignedInt($value)) {
                $errors[] = $this->l('Show below limit must be a positive number.');
            }

            if ($config == 'TB_INDICATOR_FULL_AT') {
            ...
            if ($config == 'TB_INDICATOR_DESIGN') {
                if (! in_array($value, $this->getIndicatorDesigns()) ||
                    (! (bool)Tools::getValue('TB_DISPLAY_NR_OF_ITEMS') && $value == 'none')) {
    ...
    {
        return (bool)Configuration::get('TB_DISPLAY_IN_PRODUCT_LISTS');
    }

    protected function isDisplayableOnProductPage()
    {
        return (bool)Configuration::get('TB_DISPLAY_ON_PRODUCT_PAGE');
    }
    ...
    {
        $category_list = Configuration::get('TB_DISPLAY_IN_CATS');
    ...
    {
        $showBelowLimit = (int)Configuration::get('TB_DISPLAY_WHEN_BELOW_LIMIT');
    ...
    protected function getLevelByQuantity($quantity)
    {
        ...
        $fullLimit = (int)Configuration::get('TB_INDICATOR_FULL_AT');
    ...
    protected function getCommonIndicatorViewVars()
    {
        return array(
            ...
            'indicatorDesign' => Configuration::get('TB_INDICATOR_DESIGN'),
            'useProgressiveColors' => Configuration::get('TB_ENABLE_PROGRESSIVE_COLORS'),
            'isItemsDisplayable' => (bool)Configuration::get('TB_DISPLAY_NR_OF_ITEMS'),
