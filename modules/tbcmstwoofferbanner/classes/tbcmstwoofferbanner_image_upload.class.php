...
include('tbcmstwoofferbanner_image_resize.class.php');

// Image_upload class is use for image uploading
class TbcmsTwoOfferBannerImageUpload extends Module
{
    ...
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        $savePath = _PS_MODULE_DIR_.'tbcmstwoofferbanner/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsTwoOfferBannerImageResize($save_destination);
                // Resize image
