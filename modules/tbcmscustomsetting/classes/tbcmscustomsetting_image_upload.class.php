...
include('tbcmscustomsetting_image_resize.class.php');
// Image_upload class is use for image uploading
class TbcmsCustomSettingImageUpload extends Module
{
    ...
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tbcmscustomsetting/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsCustomSettingImageResize($save_destination);
                // Resize image
