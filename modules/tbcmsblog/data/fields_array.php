            ...
            'input' => array(
                ...
                array(
                    ...
                    'desc' => 'Which Column Do you want to use. displayleftcolumn,displayrightcolumn or'
                        .'displaytbcmsblogleft,displaytbcmsblogright column hook.',
                    'options' => array(
                        'query' => array(
                                array(
                                    'id' => 'default_ps',
        ...
        $this->fields_form[1]['form'] = array(
            ...
            'input' => array(
                ...
                array(
                    ...
                    'name' => 'url_format',
                    'default_val' => 'tbhotid_seo_url',
                    'values' => array(
                        array(
                            'id' => 'default_seo_url',
                            'value' => 'default_seo_url',
                            'label' => $t->l('Default SEO Friendly: http://domain'
                                .'.com/module/tbcmsblog/single/?id_post=1'),
                        ),
                        array(
                            'id' => 'tbhotid_seo_url',
                            'value' => 'tbhotid_seo_url',
