...
class TbcmsCommentClass extends ObjectModel
{
    public $id;
    public $id_parent;
    public $id_tbcms_comments;
    public $id_post;
    public $id_customer;
    public $id_guest;
    public $name;
    ...
    public static $definition = array(
        'table' => 'tbcms_comments',
        'primary' => 'id_tbcms_comments',
        'multilang' => false,
        'fields' => array(
    ...
    public function add($autodate = true, $null_values = false)
    {
        ...
        $comment_approved = (int)Configuration::get(TbcmsBlog::$tbcmsblogshortname."comment_approved");
    ...
    public static function getTopPosition()
    {
        $sql = 'SELECT MAX(`position`)
                FROM `'._DB_PREFIX_.'tbcms_comments`';
    ...
    public static function getComments($id_post = null)
    {
        ...
        $sql = 'SELECT * FROM `'._DB_PREFIX_.'tbcms_comments` xc  WHERE xc.`id_post` = '.$id_post
    ...
    public static function getCountComments($id_post = null)
    {
        ...
        $sql = 'SELECT COUNT(id_tbcms_comments) AS total_comment FROM `'._DB_PREFIX_.'tbcms_comments` xc '
