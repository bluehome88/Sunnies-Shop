...
include('tbcmscustomer_service_image_resize.class.php');
// Image_upload class is use for image uploading
class TbcmsCustomerServicesImageUpload extends Module
{
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tbcmscustomerservices/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsCustomerServicesImageResize($save_destination);
                // Resize image
