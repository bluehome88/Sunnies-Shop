...
include('tbcmspaymenticon_image_resize.class.php');
// Image_upload class is use for image uploading
class TbcmsPaymentIconImageUpload extends Module
{
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        $savePath = _PS_MODULE_DIR_.'tbcmspaymenticon/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsPaymentIconImageResize($save_destination);
                // Resize image
