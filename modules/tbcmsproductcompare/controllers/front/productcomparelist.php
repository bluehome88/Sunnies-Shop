...
class TbcmsProductCompareProductCompareListModuleFrontController extends ModuleFrontController
{
    public function __construct()
    {
        parent::__construct();
        $this->context = Context::getContext();
        include_once($this->module->getLocalPath().'tbcmsproductcompare.php');
    }
    /**
    ...
    {
        parent::initContent();
        $tbcms_obj = new TbcmsProductCompare();
        $prod = $tbcms_obj->getAllCompareProduct();
        ...
        $this->setTemplate('module:tbcmsproductcompare/views/templates/front/tbcmsproduct_compare.tpl');
    }
}
