...
class TbcmsProductCompare extends Module
{
    public function __construct()
    {
        $this->name = 'tbcmsproductcompare';
        ...
        $this->displayName = $this->l('TemplateBeta - Product Compare');
    ...
    public function install()
    {
        ...
        if (!$context->cookie->__isset('tbcmscompare_product_1')) {
            $context->cookie->__set('tbcmscompare_product_1', '');
        }

        if (!$context->cookie->__isset('tbcmscompare_product_2')) {
            $context->cookie->__set('tbcmscompare_product_2', '');
        }

        if (!$context->cookie->__isset('tbcmscompare_product_3')) {
            $context->cookie->__set('tbcmscompare_product_3', '');
        }

        if (!$context->cookie->__isset('tbcmscompare_product_4')) {
            $context->cookie->__set('tbcmscompare_product_4', '');
        }
    ...
    public function uninstall()
    {
        $context = Context::getContext();
        if ($context->cookie->__isset('tbcmscompare_product_1')) {
            $context->cookie->__unset('tbcmscompare_product_1', '');
        }

        if ($context->cookie->__isset('tbcmscompare_product_2')) {
            $context->cookie->__unset('tbcmscompare_product_2', '');
        }

        if ($context->cookie->__isset('tbcmscompare_product_3')) {
            $context->cookie->__unset('tbcmscompare_product_3', '');
        }

        if ($context->cookie->__isset('tbcmscompare_product_4')) {
            $context->cookie->__unset('tbcmscompare_product_4', '');
        }
    ...
    {
        $context = Context::getContext();
        $this->smarty->assign('prod_1', $context->cookie->__get('tbcmscompare_product_1'));
        $this->smarty->assign('prod_2', $context->cookie->__get('tbcmscompare_product_2'));
        $this->smarty->assign('prod_3', $context->cookie->__get('tbcmscompare_product_3'));
        $this->smarty->assign('prod_4', $context->cookie->__get('tbcmscompare_product_4'));
    ...
    public function countCompareProductCookie()
    {
        $context = Context::getContext();
        $tmp = 0;
        if ($context->cookie->__get('tbcmscompare_product_1') != '') {
            $tmp++;
        }

        if ($context->cookie->__get('tbcmscompare_product_2') != '') {
            $tmp++;
        }

        if ($context->cookie->__get('tbcmscompare_product_3') != '') {
            $tmp++;
        }

        if ($context->cookie->__get('tbcmscompare_product_4') != '') {
            $tmp++;
        }
    ...
    public function getAllCompareProduct()
    {
        ...
        if ($context->cookie->__get('tbcmscompare_product_1') != '') {
            $prod_info_1['prod'] = new Product($context->cookie->__get('tbcmscompare_product_1'));
            $prod_info_1['all_img'] = Image::getImages($id_lang, $context->cookie->__get('tbcmscompare_product_1'));
            $prod_info_1['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_1')
            );
        ...
        if ($context->cookie->__get('tbcmscompare_product_2') != '') {
            $prod_info_2['prod'] = new Product($context->cookie->__get('tbcmscompare_product_2'));
            $prod_info_2['all_img'] = Image::getImages($id_lang, $context->cookie->__get('tbcmscompare_product_2'));
            $prod_info_2['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_2')
            );
        ...
        if ($context->cookie->__get('tbcmscompare_product_3') != '') {
            $prod_info_3['prod'] = new Product($context->cookie->__get('tbcmscompare_product_3'));
            $prod_info_3['all_img'] = Image::getImages($id_lang, $context->cookie->__get('tbcmscompare_product_3'));
            $prod_info_3['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_3')
            );
            $prod_info_3['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_3')
        ...
        if ($context->cookie->__get('tbcmscompare_product_4') != '') {
            $prod_info_4['prod'] = new Product($context->cookie->__get('tbcmscompare_product_4'));
            $prod_info_4['all_img'] = Image::getImages($id_lang, $context->cookie->__get('tbcmscompare_product_4'));
            $prod_info_4['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_4')
            );
            $prod_info_4['prod_attr'] = Product::getFrontFeaturesStatic(
                $id_lang,
                $context->cookie->__get('tbcmscompare_product_4')
