...
require_once(dirname(__FILE__).'/tbcmswishlist.php');
...
if ($context->customer->isLogged()) {
    ...
    if (($add || $delete) && empty($id_product) === false) {
        if (!isset($context->cookie->id_wishlist) || $context->cookie->id_wishlist == '') {
            ...
            $mod_wishlist = new TbcmsWishList();
    ...
    $tmp = 'modules/tbcmswishlist/views/templates/front/tbcmswishlist-ajax.tpl';
    if (Tools::file_exists_cache(_PS_THEME_DIR_.$tmp)) {
        $context->smarty->display(_PS_THEME_DIR_.$tmp);
    } elseif (Tools::file_exists_cache(dirname(__FILE__).'/views/templates/front/tbcmswishlist-ajax.tpl')) {
        $context->smarty->display(dirname(__FILE__).'/views/templates/front/tbcmswishlist-ajax.tpl');
    } else {
