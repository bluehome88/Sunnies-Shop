...
class TbcmsWishListViewModuleFrontController extends ModuleFrontController
{
    ...
    public function __construct()
    {
        ...
        include_once($this->module->getLocalPath().'tbcmswishlist.php');
    }
    ...
    public function initContent()
    {
        ...
        $this->setTemplate('module:tbcmswishlist/views/templates/front/view.tpl');
    }
}
