...
class TbcmsWishListMyWishListModuleFrontController extends ModuleFrontController
{
    public $ssl = true;
    ...
    public function assign()
    {
        ...
        if ($this->context->customer->isLogged()) {
                ...
                if (!count($errors)) {
                    ...
                    if (!count($errors)) {
                        ...
                        Mail::Send(
                            ...
                            '{message}' => $this->context->link->getModuleLink('tbcmswishlist', 'view', array(
                        ...
                        Tools::redirect($this->context->link->getModuleLink('tbcmswishlist', 'mywishlist'));
                    }
                }
            } elseif ($add) {
            ...
            Tools::redirect('index.php?controller=authentication&back='
                .urlencode($this->context->link->getModuleLink('tbcmswishlist', 'mywishlist')));
        }
        ...
        $this->setTemplate('module:tbcmswishlist/views/templates/front/mywishlist.tpl');
    }
