...
function WishlistCart(id, action, id_product, id_product_attribute, quantity, id_wishlist)
{
	$.ajax({
		type: 'GET',
		url: baseDir + 'modules/tbcmswishlist/cart.php?rand=' + new Date().getTime(),
		...
		success: function(data)
		{
			if (action == 'add')
			{
				if (isLogged == true) {
                    ...
                    $('.tbsticky-wishlist .cart-wishlist-number').html('( '+data+' )');
...
function WishlistAddProductCart(token, id_product, id_product_attribute, id_quantity)
{
	...
	$.ajax({
			type: 'GET',
			url: baseDir + 'modules/tbcmswishlist/buywishlistproduct.php?rand=' + new Date().getTime(),
			headers: { "cache-control": "no-cache" },
...
function WishlistManage(id, id_wishlist)
{
	$.ajax({
		type: 'GET',
		async: true,
		url: baseDir + 'modules/tbcmswishlist/managewishlist.php?rand=' + new Date().getTime(),
		headers: { "cache-control": "no-cache" },
...
{
	$.post(
		baseDir + 'modules/tbcmswishlist/sendwishlist.php',
		{
			token: static_token,
			id_wishlist: id_wishlist,
