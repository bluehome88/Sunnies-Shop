...
class TbcmsBestSellerProducts extends Module
{
    public $num_of_prod = 6;
    public function __construct()
    {
        $this->name = 'tbcmsbestsellerproducts';
        ...
        $this->displayName = $this->l('TemplateBeta - Best Seller');
    ...
    public function showFrontSideResult($num_of_prod = '')
    {
        ...
        if ($main_heading['main_status']) {
            ...
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_HOME_TITLE', $id_lang);
            $main_heading_data['title'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_HOME_SUB_TITLE', $id_lang);
            $main_heading_data['short_desc'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_HOME_DESC', $id_lang);
            $main_heading_data['desc'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_IMAGE', $id_lang);
            $main_heading_data['image'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_IMAGE_LINK', $id_lang);
            $main_heading_data['link'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_IMAGE_SIDE');
            $main_heading_data['image_side'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_IMAGE_STATUS');
            $main_heading_data['image_status'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_LEFT_TITLE', $id_lang);
            $main_heading_data['left_title'] = $tmp;
            $tmp = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_RIGHT_TITLE', $id_lang);
        ...
        $disArrResult['data'] = $tb_obj_prod->displayBestSellers($num_of_prod);
        $disArrResult['status'] = empty($disArrResult['data'])?false:true;
        $disArrResult['home_status'] = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_HOME');
        $disArrResult['left_status'] = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_LEFT');
        $disArrResult['right_status'] = Configuration::get('TBCMSTABPRODUCTS_BEST_SELLER_PROD_RIGHT');
    ...
    {
        if (!Cache::isStored('tbcmsbestsellerproducts_display_home.tpl')) {
            ...
            Cache::store('tbcmsbestsellerproducts_display_home.tpl', $output);
        }

        return Cache::retrieve('tbcmsbestsellerproducts_display_home.tpl');
    }

    public function hookdisplayLeftColumn()
    {
        if (!Cache::isStored('tbcmsbestsellerproducts_display_left.tpl')) {
            ...
            Cache::store('tbcmsbestsellerproducts_display_left.tpl', $output);
        }
        
        return Cache::retrieve('tbcmsbestsellerproducts_display_left.tpl');
    }

    public function hookdisplayRightColumn()
    {
        if (!Cache::isStored('tbcmsbestsellerproducts_display_right.tpl')) {
            $result = $this->showFrontSideResult($this->num_of_prod);
            if ($result) {
            ...
            Cache::store('tbcmsbestsellerproducts_display_right.tpl', $output);
        }

        return Cache::retrieve('tbcmsbestsellerproducts_display_right.tpl');
    }
}
