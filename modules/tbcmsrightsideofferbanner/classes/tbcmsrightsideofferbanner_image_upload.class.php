...
include('tbcmsrightsideofferbanner_image_resize.class.php');
// Image_upload class is use for image uploading
class TbcmsRightSideOfferBannerImageUpload extends Module
{
    ...
    public function imageUploading($image_src_1, $old_file)
    {
        ...
        /************resize settings***************/
        // $savePath = _PS_BASE_URL_._MODULE_DIR_.'tbcmsmultibanner/views/img/';
        $savePath = _PS_MODULE_DIR_.'tbcmsrightsideofferbanner/views/img/';
        ...
        if ($resultType) {
            ...
            if ($resultUpload) {//success
                $this->resizeObj = new TbcmsRightSideOfferBannerImageResize($save_destination);
                // Resize image
